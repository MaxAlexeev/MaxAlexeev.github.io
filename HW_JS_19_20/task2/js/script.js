...
console.log("Skills of all users",_.sortBy(_.uniq(_.flatten(_.map(data,'skills')))));
console.log("Names by friends",_.sortBy(_.map(_.orderBy(data, 'friends.length'), 'name')));
console.log("All friends of all users", _.uniq(_.map(_.flatten(_.map(data,'friends')),'name')));
 });
